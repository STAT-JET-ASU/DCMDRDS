...
Using the same logic as a traditional confidence interval, a Y% bootstrap percentile interval is based on the middle Y% percent of the sampling distribution. 
